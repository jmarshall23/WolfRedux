...
static statsItem_t statsItems[] = {
	{ "end_time",        168,    214,        0,    {1.0f,  1.0f,   1.0f,   1.0f},  "%02i:%02i:%02i",    348,    0,    {1.0f,  1.0f,   1.0f,   1.0f},  3 },
	{ "end_objectives",  28,     214,        0,    {1.0f,  1.0f,   1.0f,   1.0f},  "%i/%i",         348,    0,    {1.0f,  1.0f,   1.0f,   1.0f},  2 },
	{ "end_secrets", 28,     214,        0,    {1.0f,  1.0f,   1.0f,   1.0f},  "%i/%i",         348,    0,    {1.0f,  1.0f,   1.0f,   1.0f},  2 },
	{ "end_treasure",    28,     214,        0,    {0.62f, 0.56f,  0.0f,   1.0f},  "%i/%i",         348,    0,    {1.0f,  1.0f,   1.0f,   1.0f},  2 },
	{ "end_attempts",    28,     214,        0,    {1.0f,  1.0f,   1.0f,   1.0f},  "%i",                348,    0,    {1.0f,  1.0f,   1.0f,   1.0f},  1 },
...
//	CG_Text_Paint(280, 120, 2, 0.25f, color2, va("%s", CG_translateString("end_title")), 0, 0, ITEM_TEXTSTYLE_SHADOWEDMORE);
	...
	CG_Text_Paint( 270, 120, 2, 0.313f, color2, va( "%s", CG_translateString( "end_title" ) ), 0, 0, 0 );
...
//		CG_Text_Paint(250, 320, 2, 0.3f, color2, va("%s", CG_translateString("end_noexit")), 0, 0, ITEM_TEXTSTYLE_SHADOWEDMORE);
		//----(SA)	scale change per MK
		CG_Text_Paint( 260, 320, 2, 0.225f, color2, va( "%s", CG_translateString( "end_noexit" ) ), 0, 0, 0 );
	} else {
		// "forward to proceed"
//		CG_Text_Paint(230, 320, 2, 0.3f, color2, va("%s", CG_translateString("end_exit")), 0, 0, ITEM_TEXTSTYLE_SHADOWEDMORE);
		//----(SA)	scale change per MK
		CG_Text_Paint( 250, 320, 2, 0.225f, color2, va( "%s", CG_translateString( "end_exit" ) ), 0, 0, 0 );
	}
