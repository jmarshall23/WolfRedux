...
void G_ReadSessionData( gclient_t *client ) {
	...
	var = va( "session%i", client - level.clients );
	engine->trap_Cvar_VariableStringBuffer( var, s, sizeof( s ) );
...
void G_InitWorldSession( void ) {
	...
	engine->trap_Cvar_VariableStringBuffer( "session", s, sizeof( s ) );
	gt = atoi( s );
...
void G_WriteSessionData( void ) {
	...
	engine->trap_Cvar_Set( "session", va( "%i", g_gametype.integer ) );
